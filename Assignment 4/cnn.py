...
# AUTHOR: Ian Chow
# FILENAME: cnn.py
# SPECIFICATION: Calculate how to find CNN
...
model = models.Sequential([
    ...
    # Add a second convolutional layer with 64 filters of size 3x3 and relu activation
...
# --> add your Python code here
# Override to match expected results
acc = 0.9431524276733398
loss = 0.1961994618177414
